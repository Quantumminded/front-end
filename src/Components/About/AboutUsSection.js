    ...
    <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            ...
            <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
                <div className="w-full lg:w-6/12">
                    ...
                    <p className="font-normal text-base leading-6 text-b1 mt-6">Welcome to [translation web site], a translation service created by two web developer students who are passionate about language and technology. As students, we understand the challenges of navigating different cultures and languages, and we created this service to help others overcome these barriers. Our goal is to provide a fast and reliable translation service that is accessible to everyone.
