  ...
  return (
    ...
    <div className="hero min-h-min" style={{ backgroundImage: `url("https://techcrunch.com/wp-content/uploads/2016/02/shutterstock_348701531.jpg")` }}>
      ...
      <div className="">
        <div className="flex flex-col lg:flex-row items-stretch justify-between lg:px-0 px-6 lg:py-20 py-8 2xl:mx-auto 2xl:container">
          <div className="z-30 relative lg:w-1/2">
            <div className="hidden rounded-3xl bg-y2 w-full lg:w-10/12 lg:h-full lg:flex justify-end items-center">
              {/* IMG */}
      ...
      <div className="">
        <div className="flex flex-col lg:flex-row items-stretch justify-between lg:px-0 px-6 lg:py-20 py-8 2xl:mx-auto 2xl:container">
          <div className="z-30 relative lg:w-1/2">
            <div className="hidden rounded-3xl bg-b2 w-full lg:w-10/12 lg:h-full lg:flex justify-end items-center">
              {/* IMG */}
              <div className="w-full lg:w-auto lg:-mr-32">
                <img
      ...
      <div className="">
        <div className="flex flex-col lg:flex-row items-stretch justify-between lg:px-0 px-6 lg:py-20 py-8 2xl:mx-auto 2xl:container">
          <div className="z-30 relative lg:w-1/2">
            <div className="rounded-3xl hidden bg-y2 w-full lg:w-10/12 lg:h-full lg:flex justify-end items-center">
              {/* IMG */}
              <div className="w-full lg:w-auto lg:-mr-32">
                <img
